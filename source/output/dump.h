...
public:
    ...
    void DumpToTXT(const std::vector<typename OpengaAdapter<SimType>::Result> &results) const;
    void DumpToCSV(const std::vector<typename OpengaAdapter<SimType>::Result> &results) const;
    void DumpToShellScript(const std::vector<typename OpengaAdapter<SimType>::Result> &results);
